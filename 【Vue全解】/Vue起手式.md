...
**Vue的历史**\
前端三大主流框架Vue、Angular.js、React.js。\
...
## 目标一: 项目搭建
**方法一:使用@Vue/cli**
> 利用@Vue/cli，不用学webpack也能用Vue。\
> @Vue/cli是创建Vue的初始化工具，webpack的升级版，帮你把所有的webpack loader、webpack plugin配好了。
